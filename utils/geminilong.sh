...
#SBATCH --mail-user=david.goudenege@sb-roscoff.fr
...
# Example
# geminilong "phage_annotation -i /shared/projects/dynamic/input/phages_FNA -o /shared/projects/dynamic/finalresult/gemini_phage_annotation"
# geminilong "myVIRIDIC -i /home/umr7139/gv/dgoudenege/db/phageDB/FNA_filtered -o /home/umr7139/gv/dgoudenege/db/phageDB/FNA_filtered_viridic"