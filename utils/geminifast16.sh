...
#SBATCH --mail-user=dooguy@gmail.com
...
# Example
# geminifast16 "phage_annotation -i /shared/projects/dynamic/input/phages_FNA -o /shared/projects/dynamic/finalresult/gemini_phage_annotation"